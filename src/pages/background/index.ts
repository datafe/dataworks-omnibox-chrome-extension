...
const products = [
  { keywords: [chrome.i18n.getMessage('dataStudio'), 'data', 'ide', 'studio', '开发'], content: chrome.i18n.getMessage('dataStudio'), description: chrome.i18n.getMessage('dataStudio') },
  ...
  { keywords: [chrome.i18n.getMessage('dataAnalytics'), 'da', 'analyze', 'analytics', '分析'], content: chrome.i18n.getMessage('dataAnalytics'), description: chrome.i18n.getMessage('dataAnalytics') },
