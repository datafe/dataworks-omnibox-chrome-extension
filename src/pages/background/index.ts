...
// 不要显示 url
const doNotShowUrlList = [chrome.i18n.getMessage('mds'), chrome.i18n.getMessage('vscodeExtension')];
...
const bizLinks = [
  // global site
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dwConsole')]: 'https://dataworks.console.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-cn-shanghai.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-cn-hangzhou.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-cn-shenzhen.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-cn-beijing.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-cn-chengdu.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-cn-zhangjiakou.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-cn-hongkong.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-ap-southeast-1.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-ap-southeast-3.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-ap-southeast-5.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-us-west-1.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-eu-central-1.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-cn-shanghai-finance-1.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-cn-shenzhen-finance-1.data.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('model')]: 'https://model-cn-north-2-gov-1.data.aliyun.com',
...
const devBizLinks = [
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dwConsole')]: 'https://pre-dataworks.console.aliyun.com',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('dataService')]: 'https://mgdone.alibaba-inc.com/file/105221205609020',
    },
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('dataService')]: 'https://aliyuque.antfin.com/dataworks/utwtnt',
    },
  },
];
...
const devLinks = [
  ...
  },
  {
    ...
    urlMap: {
      [chrome.i18n.getMessage('dwConsole')]: ' https://aem.alibaba-inc.com/project/a2c1h.11154984/page/board',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('dgc')]: 'https://mds-portal.alibaba-inc.com/applications/detail?appName=data-governance-center&appId=4250001',
  ...
  },
  {
    ...
    urlMap: {
      ...
      [chrome.i18n.getMessage('normandy')]: 'https://cc.alibaba-inc.com/cloudAccountManage/masAccount?tab=RELATED',
      [chrome.i18n.getMessage('quanxi')]: 'https://quanxi-account.aliyun-inc.com/#/MyAccountManage',
      [chrome.i18n.getMessage('bffConsole')]: 'https://nrtp.alibaba-inc.com',
      [chrome.i18n.getMessage('bffPlatform')]: 'https://pre-bff.dw.alibaba-inc.com/bff-platform',
    },
  },
];
...
const products = [
  ...
  { keywords: [chrome.i18n.getMessage('oneboxProjects')], content: chrome.i18n.getMessage('oneboxProjects'), description: chrome.i18n.getMessage('oneboxProjects') },
  ...
  { keywords: [chrome.i18n.getMessage('uiCommand'), 'dcd', 'command', 'uri'], content: chrome.i18n.getMessage('uiCommand'), description: chrome.i18n.getMessage('uiCommand') },
  { keywords: [chrome.i18n.getMessage('dwConsole'), 'console', '管控台', '控制台'], content: chrome.i18n.getMessage('dwConsole'), description: chrome.i18n.getMessage('dwConsole') },
  ...
  { keywords: [chrome.i18n.getMessage('dataWorks'), 'dataworks', 'dw'], content: chrome.i18n.getMessage('dataWorks'), description: chrome.i18n.getMessage('dataWorks') },
